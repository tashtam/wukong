 ...
 * It reads input from the board and splits it into primary and secondary commands.
 */
public class Parser {
    ...
    public Command getCommand() {
        ...
        String firstWord = tokens.length > 0 ? tokens[0] : null;
        String secondWord = tokens.length > 1 ? tokens[1] : null;

        String validationMessage = validPrimaryCommands.handleCommand(firstWord);
